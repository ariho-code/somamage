    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('superadmin', 'Super Admin'), ('headteacher', 'Headteacher'), ('teacher', 'Teacher'), ('bursar', 'Bursar'), ('parent', 'Parent'), ('student', 'Student')], max_length=20)),
